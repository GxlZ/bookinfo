...
func MakeHTTPHandler(endpoints Endpoints) http.Handler {
	...
	m.Methods("POST").Path("/v1/post").Handler(httptransport.NewServer(
		endpoints.PostEndpoint,
		DecodeHTTPPostZeroRequest,
		EncodeHTTPGenericResponse,
		serverOptions...,
	))

	m.Methods("GET").Path("/v1/get").Handler(httptransport.NewServer(
...
// DecodeHTTPPostZeroRequest is a transport/http.DecodeRequestFunc that
// decodes a JSON-encoded post request from the HTTP request
// body. Primarily useful in a server.
func DecodeHTTPPostZeroRequest(_ context.Context, r *http.Request) (interface{}, error) {
	var req pb.PostReq
...
func DecodeHTTPGetZeroRequest(_ context.Context, r *http.Request) (interface{}, error) {
	...
	if IdGetStrArr, ok := queryParams["id"]; ok {
		IdGetStr := IdGetStrArr[0]
		IdGet, err := strconv.ParseInt(IdGetStr, 10, 64)
		if err != nil {
			return nil, errors.Wrap(err, fmt.Sprintf("Error while extracting IdGet from query, queryParams: %v", queryParams))
		}
		req.Id = IdGet
	}
