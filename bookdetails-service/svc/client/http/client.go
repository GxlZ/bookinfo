...
// Package http provides an HTTP client for the BookDetails service.
package http
...
func New(instance string, options ...ClientOption) (pb.BookDetailsServer, error) {
	var cc clientConfig
...
// a JSON-encoded DetailResp response from the HTTP response body.
