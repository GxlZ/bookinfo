...
func MakeHTTPHandler(endpoints Endpoints) http.Handler {
	...
	m.Methods("GET").Path("/v1/detail").Handler(s)
	return m
}
...
func DecodeHTTPDetailZeroRequest(_ context.Context, r *http.Request) (interface{}, error) {
	...
	if IdDetailStrArr, ok := queryParams["id"]; ok {
		IdDetailStr := IdDetailStrArr[0]
		IdDetail, err := strconv.ParseInt(IdDetailStr, 10, 64)
		if err != nil {
			return nil, errors.Wrap(err, fmt.Sprintf("Error while extracting IdDetail from query, queryParams: %v", queryParams))
		}
		req.Id = IdDetail
	}
